...
namespace ProyectoHerencia
{
    ...
    interface IAnimalesYDeportes //metodos obligatorios
    {
        string tipoDeporte();
        Boolean esOlimpico();
    }
    ...
    class Caballo : Mamiferos, IMamiferosTerretres, IAnimalesYDeportes, IsaltoConPAtas

    {
        ...
        public string tipoDeporte() //metodo amarrados a interfaz AnimalesYDeportes
        {
            return "Hipica";
        }

        public Boolean esOlimpico() //metodo amarrados a interfaz AnimalesYDeportes
        {
            return true;
        }
    }
